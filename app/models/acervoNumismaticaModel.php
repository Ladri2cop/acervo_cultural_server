...
class AcervoNumismaticaModel extends Model
{
    protected static $table = 'acervo_numismatica';
    protected static $primaryKey = 'id_acervo_numismatica';

    public static function getById($id)
    {
        $sql = "SELECT 
            id_acervo_numismatica,
            codigo_interno,
            no_inventario,
            fotografia,
            tipo_obra,
     ...
     * @return int|false
     */
    public static function getModuloId($search = 'Acervo Numismática')
    {
