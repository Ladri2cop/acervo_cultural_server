...
define('DEV_PATH', '/ACERVO_CULTURAL/'); // Ruta del proyecto en desarrollo después de htdocs o www
define('LIVE_PATH', '/ACERVO_CULTURAL/'); // Ruta del proyecto en producción
